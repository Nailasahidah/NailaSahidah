...
public class Soal21_SumIntegers {
    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);

        System.out.print("Enter the number of balls tu drop: ");
...
Enter the number of balls tu drop: 2
Enter the number of slots in the bean machine: 3
