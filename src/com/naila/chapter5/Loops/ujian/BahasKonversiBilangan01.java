...
public class BahasKonversiBilangan01 {
    public static void main(String[] args) {
        Scanner input = new Scanner(System.in) ;
        System.out.println("Aplikasi Konversi Sistem Bilangan");
        ...
        switch (menu){
            case 1 -> {
                System.out.println("Anda memilih Menu Konversi Bilangan Biner ke bilangan Desimal");
