...
public class Soal24_DisplayCurrentDateAndTime {
...
current time. Revise this example to display the current date and time. The calendar example in Listing 6.12, PrintCalendar.java, should give you some ideas on
